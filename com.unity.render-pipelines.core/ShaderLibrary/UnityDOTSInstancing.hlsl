...
uint ComputeDOTSInstanceDataAddressFromInstanceIndex(uint metadata, uint instanceIndex, uint stride)
{
...
{
    return ComputeDOTSInstanceDataAddressFromInstanceIndex(metadata, GetDOTSInstanceIndex(), stride);
}
