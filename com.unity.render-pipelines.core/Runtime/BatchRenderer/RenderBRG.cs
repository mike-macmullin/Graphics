...
namespace UnityEngine.Rendering
{
    ...
    unsafe class SceneBRG
    {
        ...
        private MetadataValue m_InstanceMaterialMetadata;
        ...
        public int renderersCount => m_AddedRenderers.Count;
        public GraphicsBuffer persistentInstanceData { get { return m_GPUPersistentInstanceData; } }
        public MetadataValue instaceMaterialMetadata { get { return m_InstanceMaterialMetadata; } }
        ...
        public void Initialize(List<MeshRenderer> renderers, DeferredMaterialBRG deferredMaterialBRG)
        {
            ...
            m_InstanceMaterialMetadata = CreateMetadataValue(deferredMaterialInstanceDataID, deferredMaterialDataOffset * UnsafeUtility.SizeOf<Vector4>(), true);
            batchMetadata[13] = m_InstanceMaterialMetadata;
